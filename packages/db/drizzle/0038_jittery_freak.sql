...
--> statement-breakpoint
ALTER TABLE "billing_period_cost_baremetal_agg" DISABLE ROW LEVEL SECURITY;--> statement-breakpoint
ALTER TABLE "billing_period_cost_detail" DISABLE ROW LEVEL SECURITY;--> statement-breakpoint
ALTER TABLE "billing_period_cost_enrichment" DISABLE ROW LEVEL SECURITY;--> statement-breakpoint
DROP TABLE "billing_period_cost_baremetal_agg" CASCADE;--> statement-breakpoint
DROP TABLE "billing_period_cost_detail" CASCADE;--> statement-breakpoint
DROP TABLE "billing_period_cost_enrichment" CASCADE;--> statement-breakpoint
ALTER TABLE "platform_cost_monthly" DROP CONSTRAINT "platform_cost_monthly_project_id_project_id_fk";
--> statement-breakpoint
DROP INDEX "platform_cost_monthly_period_staff_idc_card_uk";--> statement-breakpoint
...
ALTER TABLE "platform_cost_monthly" ADD COLUMN "data_center_id" text;--> statement-breakpoint
ALTER TABLE "platform_cost_monthly" ADD COLUMN "gpu_card_type_id" text;--> statement-breakpoint
ALTER TABLE "platform_cost_monthly" ADD COLUMN "total_consumption" numeric(15, 4);--> statement-breakpoint
ALTER TABLE "platform_cost_monthly" ADD COLUMN "voucher_consumption" numeric(15, 4);--> statement-breakpoint
ALTER TABLE "platform_cost_monthly" ADD COLUMN "total_card_hours" numeric(15, 4);--> statement-breakpoint
ALTER TABLE "platform_cost_monthly" ADD COLUMN "pricing_snapshot_id" text;--> statement-breakpoint
ALTER TABLE "platform_cost_monthly" ADD COLUMN "source_line_ids" jsonb;--> statement-breakpoint
...
CREATE UNIQUE INDEX "platform_cost_monthly_sum_uk" ON "platform_cost_monthly" USING btree ("billing_period_id") WHERE "platform_cost_monthly"."type" = 'sum';--> statement-breakpoint
ALTER TABLE "platform_cost_monthly" DROP COLUMN "project_id";--> statement-breakpoint
ALTER TABLE "platform_cost_monthly" DROP COLUMN "allocation_percent";--> statement-breakpoint
ALTER TABLE "platform_cost_monthly" DROP COLUMN "source_raw_ids";