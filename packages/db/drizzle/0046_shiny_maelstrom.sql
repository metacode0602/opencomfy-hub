...
ALTER TABLE "consumption_usage_daily" ADD COLUMN "usage_month" varchar(7) NOT NULL;--> statement-breakpoint
...
CREATE INDEX "consumption_usage_daily_tenant_month_pl_idx" ON "consumption_usage_daily" USING btree ("tenant_id","usage_month","product_line");