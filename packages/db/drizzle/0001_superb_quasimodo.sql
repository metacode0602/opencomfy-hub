...
ALTER TABLE "users" ADD COLUMN "provisioned_by" text;--> statement-breakpoint
ALTER TABLE "users" ADD COLUMN "provisioned_at" timestamp with time zone;--> statement-breakpoint
...
CREATE INDEX "project_revenue_department_idx" ON "project" USING btree ("revenue_department");--> statement-breakpoint
