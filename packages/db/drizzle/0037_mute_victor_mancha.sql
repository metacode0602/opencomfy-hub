CREATE TABLE "billing_period_cost_baremetal_agg" (
...
CREATE TABLE "billing_period_cost_detail" (
	"id" text PRIMARY KEY NOT NULL,
	"billing_period_id" text NOT NULL,
	"tenant_platform_id" varchar(128) NOT NULL,
	"tenant_id" text,
...
--> statement-breakpoint
CREATE TABLE "billing_period_cost_enrichment" (
	"id" text PRIMARY KEY NOT NULL,
	"billing_period_id" text NOT NULL,
	"tenant_platform_id" varchar(128) NOT NULL,
...
--> statement-breakpoint
ALTER TABLE "platform_cost_monthly" ADD COLUMN "staff_name" varchar(128);--> statement-breakpoint
...
ALTER TABLE "billing_period_cost_detail" ADD CONSTRAINT "billing_period_cost_detail_tenant_id_tenant_id_fk" FOREIGN KEY ("tenant_id") REFERENCES "public"."tenant"("id") ON DELETE set null ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "billing_period_cost_enrichment" ADD CONSTRAINT "billing_period_cost_enrichment_tenant_id_tenant_id_fk" FOREIGN KEY ("tenant_id") REFERENCES "public"."tenant"("id") ON DELETE restrict ON UPDATE no action;--> statement-breakpoint
...
CREATE UNIQUE INDEX "billing_period_cost_baremetal_agg_uk" ON "billing_period_cost_baremetal_agg" USING btree ("billing_period_id","tenant_platform_id","idc_code","card_type");--> statement-breakpoint
CREATE INDEX "billing_period_cost_baremetal_agg_period_id_idx" ON "billing_period_cost_baremetal_agg" USING btree ("billing_period_id");--> statement-breakpoint
CREATE UNIQUE INDEX "billing_period_cost_detail_uk" ON "billing_period_cost_detail" USING btree ("billing_period_id","staff_id","project_id","idc_code","card_type");--> statement-breakpoint
CREATE INDEX "billing_period_cost_detail_period_id_idx" ON "billing_period_cost_detail" USING btree ("billing_period_id");--> statement-breakpoint
CREATE UNIQUE INDEX "billing_period_cost_enrichment_uk" ON "billing_period_cost_enrichment" USING btree ("billing_period_id","tenant_platform_id","project_id");--> statement-breakpoint
CREATE INDEX "billing_period_cost_enrichment_period_id_idx" ON "billing_period_cost_enrichment" USING btree ("billing_period_id");--> statement-breakpoint
CREATE UNIQUE INDEX "platform_cost_monthly_period_staff_idc_card_uk" ON "platform_cost_monthly" USING btree ("billing_period_id","staff_id","idc_code","card_type");