        ...
        <Body className='bg-gray-100 font-sans py-[40px]'>
          <Container className='bg-white rounded-[8px] shadow-sm max-w-[600px] mx-auto p-[40px]'>
            ...
            <Section className='text-center mb-[32px]'>
              <Heading className='text-[28px] font-bold text-gray-900 m-0 mb-[8px]'>You&apos;re invited!</Heading>
              <Text className='text-[16px] text-gray-600 m-0'>Join {props.teamName} and start collaborating</Text>
            </Section>

            {/* Main Content */}
            <Section className='mb-[32px]'>
              <Text className='text-[16px] text-gray-700 mb-[16px] m-0'>Hi there,</Text>
              <Text className='text-[16px] text-gray-700 mb-[16px] m-0'>
                <strong>{props.invitedByUsername}</strong> ({props.invitedByEmail}) has invited you to join{' '}
                <strong>{props.teamName}</strong> on our platform.
              </Text>
              <Text className='text-[16px] text-gray-700 mb-[24px] m-0'>
                Accept this invitation to start collaborating with your team members and access all the tools and
            ...
            <Section className='mb-[32px]'>
              ...
              <Text className='text-[14px] break-all m-0'>
                <Link href={props.inviteLink} className='text-blue-600 underline'>
                  {props.inviteLink}
                </Link>
              </Text>
            </Section>
            ...
            <Section className='border-t border-gray-200 pt-[24px] mb-[24px]'>
              ...
              <Text className='text-[14px] text-gray-600 mb-[8px] m-0'>
                <strong>Invited by:</strong> {props.invitedByUsername} ({props.invitedByEmail})
              </Text>
            ...
            <Section className='border-t border-gray-200 pt-[24px]'>
              <Text className='text-[12px] text-gray-500 text-center m-0 mb-[8px]'>
                This invitation was sent to {props.email}. If you weren&apos;t expecting this invitation, you can safely
                ignore this email.
              </Text>
              <Text className='text-[12px] text-gray-500 text-center m-0 mb-[8px]'>
