...
export default function MetaIcon(props: SVGProps<SVGSVGElement>) {
  return (
    <svg xmlns='http://www.w3.org/2000/svg' width={192} height={192} viewBox='0 0 192 192' fill='none' {...props}>
      <g clipPath='url(#meta)'>
        <path
          fill='url(#b)'
      ...
      <defs>
        <linearGradient id='b' x1={4771.89} x2={917.775} y1={6581.35} y2={1514.83} gradientUnits='userSpaceOnUse'>
          <stop offset={0.001} stopColor='#0867DF' />
          <stop offset={0.454} stopColor='#0668E1' />
          <stop offset={0.859} stopColor='#0064E0' />
        </linearGradient>
        <linearGradient id='c' x1={863.117} x2={3613.1} y1={2713.69} y2={620.668} gradientUnits='userSpaceOnUse'>
          <stop offset={0.132} stopColor='#0064DF' />
          <stop offset={0.999} stopColor='#0064E0' />
        </linearGradient>
        <linearGradient id='d' x1={1228.1} x2={2349.22} y1={3705.15} y2={874.403} gradientUnits='userSpaceOnUse'>
          <stop offset={0.015} stopColor='#0072EC' />
          <stop offset={0.688} stopColor='#0064DF' />
        </linearGradient>
        <linearGradient id='e' x1={1056.53} x2={1193.29} y1={2304.05} y2={480.888} gradientUnits='userSpaceOnUse'>
          <stop offset={0.073} stopColor='#007CF6' />
          <stop offset={0.994} stopColor='#0072EC' />
        </linearGradient>
        <linearGradient id='f' x1={1118.67} x2={1079.37} y1={897.443} y2={604.045} gradientUnits='userSpaceOnUse'>
          <stop offset={0.073} stopColor='#007FF9' />
          <stop offset={1} stopColor='#007CF6' />
        </linearGradient>
        <linearGradient id='g' x1={948.487} x2={1548.46} y1={435.378} y2={1712.05} gradientUnits='userSpaceOnUse'>
          <stop offset={0.073} stopColor='#007FF9' />
          <stop offset={1} stopColor='#0082FB' />
        </linearGradient>
        <linearGradient id='h' x1={810.919} x2={1534.45} y1={1734.88} y2={731.248} gradientUnits='userSpaceOnUse'>
          <stop offset={0.28} stopColor='#007FF8' />
          <stop offset={0.914} stopColor='#0082FB' />
        </linearGradient>
        <linearGradient id='i' x1={1788.89} x2={3396.01} y1={466.392} y2={6397.2} gradientUnits='userSpaceOnUse'>
          <stop stopColor='#0082FB' />
          <stop offset={1} stopColor='#0081FA' />
        </linearGradient>
        <linearGradient id='j' x1={1452} x2={509.127} y1={269.626} y2={2181.27} gradientUnits='userSpaceOnUse'>
          <stop offset={0.062} stopColor='#0081FA' />
          <stop offset={1} stopColor='#0080F9' />
        </linearGradient>
        <linearGradient id='k' x1={802.399} x2={1563.17} y1={1683.5} y2={1163.72} gradientUnits='userSpaceOnUse'>
          <stop stopColor='#027AF3' />
          <stop offset={1} stopColor='#0080F9' />
        </linearGradient>
        <linearGradient id='l' x1={606.893} x2={1994.42} y1={1235.65} y2={1235.65} gradientUnits='userSpaceOnUse'>
          <stop stopColor='#0377EF' />
          <stop offset={0.999} stopColor='#0279F1' />
        </linearGradient>
        <linearGradient id='m' x1={1018.45} x2={1799.66} y1={1054.97} y2={1516.15} gradientUnits='userSpaceOnUse'>
          <stop offset={0.002} stopColor='#0471E9' />
          <stop offset={1} stopColor='#0377EF' />
        </linearGradient>
        <linearGradient id='n' x1={1482.75} x2={4034.55} y1={1304.7} y2={4522.9} gradientUnits='userSpaceOnUse'>
