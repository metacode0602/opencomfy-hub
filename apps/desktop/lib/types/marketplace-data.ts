...
export const styleTemplates: StyleTemplate[] = [
  {
    ...
    thumbnail: "/images/unsplash/photo-1563089145-599997674d42.jpg",
    author: "Genesis官方",
    likes: 2847,
    uses: 15234,
    tags: ["赛博朋克", "霓虹", "未来", "城市"],
  ...
  },
  {
    ...
    category: "landscape",
    thumbnail: "/images/unsplash/photo-1501785888041-af3ef285b470.jpg",
    author: "艺术工坊",
    likes: 1923,
    uses: 8721,
    tags: ["水墨", "山水", "中国风", "传统"],
  ...
  },
  {
    ...
    category: "anime",
    thumbnail: "/images/unsplash/photo-1578632767115-351597cf2477.jpg",
    author: "动漫社区",
    likes: 4521,
    uses: 28934,
    tags: ["动漫", "二次元", "插画", "角色"],
  ...
  },
  {
    ...
    category: "realistic",
    thumbnail: "/images/unsplash/photo-1533738363-b7f9aef128ce.jpg",
    author: "Genesis官方",
    likes: 3156,
    uses: 19823,
    tags: ["写实", "电影", "人像", "质感"],
  ...
  },
  {
    ...
    category: "abstract",
    thumbnail: "/images/unsplash/photo-1579783902614-a3fb3927b6a5.jpg",
    author: "艺术工坊",
    likes: 1678,
    uses: 7234,
    tags: ["油画", "印象派", "艺术", "梦幻"],
  ...
  },
  {
    ...
    category: "illustration",
    thumbnail: "/images/unsplash/photo-1558591710-4b4a1ae0f04d.jpg",
    author: "设计师联盟",
    likes: 892,
    uses: 4521,
    tags: ["极简", "线条", "设计", "简约"],
...
export const effectTemplates: EffectTemplate[] = [
  {
    ...
    category: "transition",
    thumbnail: "/images/unsplash/photo-1536440136628-849c177e76a1.jpg",
    author: "Genesis官方",
    likes: 1823,
    uses: 12456,
    tags: ["转场", "电影", "专业", "过渡"],
  ...
  },
  {
    ...
    category: "particle",
    thumbnail: "/images/unsplash/photo-1534796636912-3b95b3ab5986.jpg",
    author: "特效工作室",
    likes: 2341,
    uses: 8923,
    tags: ["粒子", "魔法", "特效", "炫酷"],
  ...
  },
  {
    ...
    category: "motion",
    thumbnail: "/images/unsplash/photo-1492691527719-9d1e07e534b4.jpg",
    author: "Genesis官方",
    likes: 1567,
    uses: 7823,
    tags: ["运镜", "追踪", "动态", "电影"],
  ...
  },
  {
    ...
    category: "style",
    thumbnail: "/images/unsplash/photo-1518676590629-3dcbd9c5a5c9.jpg",
    author: "复古社区",
    likes: 1234,
    uses: 5623,
    tags: ["复古", "胶片", "怀旧", "80年代"],
  ...
  },
  {
    ...
    category: "text",
    thumbnail: "/images/unsplash/photo-1456324504439-367cee3b3c32.jpg",
    author: "设计师联盟",
    likes: 987,
    uses: 4521,
    tags: ["文字", "动画", "标题", "字幕"],
  ...
  },
  {
    ...
    category: "motion",
    thumbnail: "/images/unsplash/photo-1550684848-fac1c5b4e853.jpg",
    author: "特效工作室",
    likes: 2156,
    uses: 6234,
...
export const workflowTemplates: WorkflowTemplate[] = [
  {
    ...
    category: "image",
    thumbnail: "/images/unsplash/photo-1531746020798-e6953c6e8e04.jpg",
    author: "Genesis官方",
    likes: 3421,
    uses: 23456,
    tags: ["人像", "精修", "美化", "一键"],
  ...
  },
  {
    ...
    category: "upscale",
    thumbnail: "/images/unsplash/photo-1518837695005-2083093ee35b.jpg",
    author: "Genesis官方",
    likes: 2876,
    uses: 18923,
    tags: ["超分", "4K", "放大", "增强"],
  ...
  },
  {
    ...
    category: "inpaint",
    thumbnail: "/images/unsplash/photo-1506905925346-21bda4d32df4.jpg",
    author: "Genesis官方",
    likes: 2543,
    uses: 15678,
    tags: ["抠图", "换背景", "智能", "合成"],
  ...
  },
  {
    ...
    category: "controlnet",
    thumbnail: "/images/unsplash/photo-1544367567-0f2fcb009e0b.jpg",
    author: "AI研究院",
    likes: 1987,
    uses: 9823,
  ...
  },
  {
    ...
    category: "video",
    thumbnail: "/images/unsplash/photo-1536240478700-b869070f9279.jpg",
    author: "视频工作室",
    likes: 1654,
    uses: 7234,
    tags: ["视频", "风格迁移", "艺术", "转换"],
  ...
  },
  {
    ...
    category: "custom",
    thumbnail: "/images/unsplash/photo-1542204165-65bf26472b9b.jpg",
    author: "AI研究院",
    likes: 1234,
    uses: 4567,
    tags: ["多角色", "场景", "高级", "一致性"],
