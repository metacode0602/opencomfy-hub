...
export function SuppliersContent() {
  ...
  const stats = {
    ...
    cooperating: mockSuppliers.filter((s) => s.status === 'cooperating').length,
    totalDataCenters: mockDataCenters.length,
    totalDevices: mockSuppliers.reduce((sum, s) => sum + s.totalDeviceCount, 0),
    monthlySettlement: mockSuppliers.reduce((sum, s) => sum + s.monthlySettlement, 0),
  }
