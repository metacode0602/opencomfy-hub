...
import { styleTemplates, effectTemplates, workflowTemplates, dancingTemplates } from "@/lib/types/marketplace-data"
  ...
  const sections = [
    {
      title: "璇非摇手势舞",
      icon: Film,
      href: "/dashboard/dancing/zk-video",
      items: dancingTemplates.slice(0, 4),
      type: "dancing" as const,
      ...
      <div className="sticky top-0 z-10 bg-background/80 backdrop-blur-xl border-b border-border">
        <div className="max-w-7xl mx-auto px-6 py-4">
          <div className="flex flex-col sm:flex-row gap-4 items-start sm:items-center justify-between">
            <div>
              <h1 className="text-2xl font-bold">舞蹈生成</h1>
